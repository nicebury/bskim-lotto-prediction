...
⚠ 일일 호출 쿼터와 재배포 약관이 **미확인**이다. developers.naver.com 이 자동
조회를 차단해 확인하지 못했다. 그래서 백오프를 보수적으로 잡고 크론 빈도를 낮게 둔다.
사람이 확인하면 docs/wiki/90-external/naver-search-api.md 를 갱신한다.
"""
