    ...
    <div className="container">
      ...
      <article>
        ...
        <section className="section prose">
          <h2>복권은 오락이다</h2>
          <p>
            복권 한 장을 사는 일은 영화표를 사는 일과 비슷합니다. 얼마간의 기대와 즐거움을 얻고, 그
            대가로 정해진 금액을 지불합니다. 차이가 있다면 아주 낮은 가능성으로 큰 금액이 돌아올 수
            있다는 점이지만, <strong>그 가능성에 기대어 지출을 늘리는 순간 오락은 도박이
            됩니다.</strong>
          </p>
          <p>
            수학적으로 복권 구매는 장기적으로 지출한 금액보다 적게 돌려받는 활동입니다. 이것은
            비관적인 전망이 아니라 복권 제도의 설계입니다. 판매금 일부는 당첨금으로, 일부는
            복권기금으로 쓰이기 때문입니다. 따라서 복권으로 수익을 내겠다는 계획은 성립하지
            않습니다.
          </p>
          ...
          <h2>과도한 이용의 신호</h2>
          <p>
            아래에 해당하는 것이 있다면 이용 습관을 돌아볼 때입니다.
          </p>
          <ul>
          ...
          <p>
            법률에 따라 19세 미만은 복권을 구매할 수 없습니다. 미성년자를 대신해 구매해 주는 것도
            금지됩니다.
          </p>

          <h2>사칭과 사기를 조심하세요</h2>
          <p>
            &ldquo;당첨 번호를 알려 준다&rdquo;, &ldquo;번호를 맞혀 준다&rdquo;며 금액을 요구하는
            연락은 모두 사기입니다. 그런 정보는 존재하지 않습니다. 복권 구매를 대행해 준다는 사이트,
            당첨금 수령에 수수료를 요구하는 연락도 마찬가지입니다.
          </p>
          <p>
            국내에서 복권 판매는 기획재정부 복권위원회가 지정한 공식 사업자만 할 수 있습니다. 그
            밖의 경로로 판매되는 복권은 합법이 아닙니다.
          </p>
        </section>

        <Disclaimer>
          행운상자는 복권 관련 정보와 통계를 제공하는 서비스이며, 복권을 판매하거나 구매를 대행하지
          않습니다. 번호 추천은 재미용 시뮬레이션이며 당첨을 보장하지 않습니다. 19세 미만은 복권을
          구매할 수 없습니다.
        </Disclaimer>
        ...
        <section className="section prose">
          <p className="muted">
            ...
            <Link href="/lotto/recommend">번호 추천 시뮬레이터</Link> 페이지 하단에도 있습니다.
          </p>
        </section>
      </article>
      ...
      <JsonLd
        data={articleLd({
          ...
          description: '복권을 오락으로 즐기기 위한 기준과 과도한 이용의 신호를 안내합니다.',
          siteName: SITE_NAME,
          siteUrl: SITE_URL,
