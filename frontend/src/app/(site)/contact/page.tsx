  ...
  return (
    <div className="container">
      ...
      <section className="section" aria-labelledby="contact-method">
        ...
        <Card>
          {CONTACT_EMAIL ? (
            ...
            <p className="muted">
              현재 문의 창구를 준비하고 있습니다. 연락처가 마련되는 대로 이
              페이지에 안내하겠습니다.
            </p>
          )}
        </Card>
      ...
      <section className="section prose" aria-labelledby="contact-guide">
        ...
        <p>
          본 사이트의 데이터는 외부 출처에서 수집합니다. 수집 오류나 갱신 지연이
          있을 수 있습니다. 어느 회차의 어떤 값이 잘못되었는지 알려 주시면
          확인하겠습니다. 다만 실제 당첨 여부와 당첨금은 반드시 공식 발표를 통해
          확인하시기 바랍니다.
        </p>

        <h3>당첨 번호를 알려 주실 수 있나요</h3>
        <p>
          불가능합니다. 로또 번호는 무작위로 추첨되며 어떤 방법으로도 미리 알 수
          없습니다. 본 사이트의 번호 추천은 통계와 AI를 활용한 시뮬레이션이며 당첨을
          보장하지 않습니다. 자세한 내용은{" "}
        ...
        <h3>복권을 구매하고 싶습니다</h3>
        <p>
          본 사이트는 복권을 판매하거나 구매를 대행하지 않습니다. 국내에서 복권
          판매는 기획재정부 복권위원회가 지정한 공식 사업자만 할 수 있습니다.
        </p>

        <h3>뉴스 기사 삭제를 요청합니다</h3>
        <p>
          본 사이트는 기사 제목과 요약, 원문 링크만 표시하며 본문을 복제하지
          않습니다. 게재된 정보에 문제가 있다면 해당 기사의 링크와 함께 알려
          주시기 바랍니다.
        </p>
      </section>
    </div>
